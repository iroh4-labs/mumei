...
export const ReviewSchema = Type.Object(
  {
    ...
    residual: Type.Optional(
      Type.Array(ResidualItemSchema, {
        description:
          'Residual exposition (pillar D, REQ-23): signals objective verification cannot guarantee, for human review. Optional for archived-read back-compat; the orchestrator always emits it (non-empty via the always-on ai-blindspot-ceiling) for new reviews.',
      }),
    ),
  },
  {
