...
@test "compose skill wires full spec context to security-reviewer only" {
...
@test "peruse skill documents adversarial stays cold (no plan context)" {
...
@test "peruse skill injects verbatim plan body into security-reviewer (issue #66)" {
