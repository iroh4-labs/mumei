...
| Version                                                                     | Supported |
| --------------------------------------------------------------------------- | --------- |
| Latest `0.x.y` (see [Releases](https://github.com/iroha924/mumei/releases)) | Yes       |
| Older `0.x.y`                                                               | No        |
...
1. Go to <https://github.com/iroha924/mumei/security/advisories/new>.
...
(`iroha924/mumei`) and limited to the minimum required permissions per
