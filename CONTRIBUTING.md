...
document or via [GitHub Security Advisories](https://github.com/iroha924/mumei/security/advisories/new)
...
```bash
git clone https://github.com/iroha924/mumei.git
cd mumei
...
1. **Branch first, then plan.** Fork or branch from `main`
   ...
   `refactor/`, `chore/`, etc.) **before** invoking `/mumei:compose
...
2. Go to **Settings → General → Social preview** of the repo
   (`https://github.com/iroha924/mumei/settings`).
3. Click **Upload an image** and select the PNG.
4. Verify on the repo home page (`https://github.com/iroha924/mumei`) — the
...
[Issues → New issue](https://github.com/iroha924/mumei/issues/new/choose). The form
...
[GitHub Security Advisories](https://github.com/iroha924/mumei/security/advisories/new)
