...
- **特定バージョンに pin**: marketplace plugin は marketplace repo の git ref に従う。tag を pin するには `/plugin marketplace add hir4ta/mumei#v0.1.4` のように書く。
...
Pre-release (v0.1.4)。v1.0 までは破壊的変更がありうる。
